...
void merge_sort(size_t list_len, int list[list_len], int buffer[list_len / 2],
		int sorted_list[list_len]);
void merge(size_t list_len, int list[list_len], size_t helper_len,
	   int helper[helper_len], int result[list_len]);
