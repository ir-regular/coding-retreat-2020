...
// These functions are copied from challenge_1_1.c and challenge_1_2.c - this is for practice,
// I have limited time for cleanups
...
void merge_sort2(size_t list_len, int list[list_len], int buffer[list_len/2], int sorted_list[list_len]);
